// src/routes/admin/site-category.ts
import { Router } from 'express'
import { ok, fail } from '../../helpers/envelope.js'
import { guid, isoTime } from '../../helpers/id.js'
import { CATEGORIES, type ProductCategory } from '../../data/product.js'

export const adminSiteCategoryRouter = Router()

adminSiteCategoryRouter.get('/site/category/list', (_req, res) => {
  res.json(ok(CATEGORIES))
})

adminSiteCategoryRouter.post('/site/category', (req, res) => {
  const body = req.body
...
adminSiteCategoryRouter.put('/site/category/:id', (req, res) => {
...
adminSiteCategoryRouter.delete('/site/category/:id', (req, res) => {

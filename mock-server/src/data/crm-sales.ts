...
export const SALES_ORDERS: SalesOrder[] = [
  buildOrder(1, 0, 'Li Ming', 'Net 30', 7, 'confirmed', [
    { skuCode: 'SKU-001', skuName: '蓝牙耳机 Pro', name: 'Bluetooth Headset X1', spec: 'Black', price: 85, qty: 200, taxIdx: 0 },
    { skuCode: 'SKU-002', skuName: 'USB-C 充电器 65W', name: 'USB-C Charger 65W', spec: 'GaN', price: 45, qty: 500, taxIdx: 0 },
  ], 'Urgent delivery, partial allowed', -10),
  buildOrder(2, 3, 'Li Ming', 'Net 45', 14, 'shipped', [
    { skuCode: 'SKU-003', skuName: '无线键盘', name: 'Wireless Mouse M2', spec: '2.4G', price: 28, qty: 1000, taxIdx: 0 },
    { skuCode: 'SKU-004', skuName: '便携移动电源 20000mAh', name: 'Mechanical Keyboard K8', spec: 'RGB Blue', price: 120, qty: 300, taxIdx: 0 },
    { skuCode: 'SKU-005', skuName: '蓝牙音箱 S3', name: 'USB Hub 4-Port', spec: 'Aluminum', price: 18, qty: 800, taxIdx: 0 },
  ], 'Key account PO', -15),
  buildOrder(3, 1, 'Zhao Qiang', 'Net 30', 5, 'draft', [
    { skuCode: 'SKU-006', skuName: '纸箱 40x30x30', name: 'LED Strip 5m', spec: 'RGB 5050', price: 35, qty: 600, taxIdx: 0 },
  ], '', -3),
  buildOrder(4, 0, 'Li Ming', 'Prepaid', 0, 'completed', [
    { skuCode: 'SKU-007', skuName: '气泡膜 1m', name: 'Power Bank 10000mAh', spec: 'PD 22.5W', price: 55, qty: 400, taxIdx: 0 },
    { skuCode: 'SKU-008', skuName: '铝型材 40x40', name: 'Phone Stand Aluminum', spec: 'Foldable', price: 12, qty: 1000, taxIdx: 0 },
  ], 'Closed', -30),
  buildOrder(5, 2, '', 'COD', 3, 'cancelled', [
    { skuCode: 'SKU-009', skuName: '双面板 PCB', name: 'Bluetooth Speaker S3', spec: 'IPX7', price: 65, qty: 150, taxIdx: 0 },

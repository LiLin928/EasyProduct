...
const messages = {
  'zh-CN': { common: zhCommon, menu: zhMenu, basic: zhBasic, site: zhSite, product: zhProduct, mall: zhMall },
  'en-US': { common: enCommon, menu: enMenu, basic: enBasic, site: enSite, product: enProduct, mall: enMall },
}

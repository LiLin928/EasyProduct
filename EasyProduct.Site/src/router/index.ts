...
export const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'about', name: 'about', component: () => import('@/views/about/index.vue'), meta: { title: 'site.about.title' } },
      { path: 'contact', name: 'contact', component: () => import('@/views/contact/index.vue'), meta: { title: 'site.contact.title' } },
      { path: 'videos', name: 'videos', component: () => import('@/views/videos/index.vue'), meta: { title: 'site.videos.title' } },
      { path: 'downloads', name: 'downloads', component: () => import('@/views/downloads/index.vue'), meta: { title: 'site.downloads.title' } },
